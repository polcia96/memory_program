...
void Element::setState(){
    ...
    if (remembering_rate_ > days_passesd)
        ...
        state_ = FOR_REPETITION; //ostatecznie do powtorki
    else if(remembering_rate_ < days_passesd)
        state_ = OVERDUE; //ostatecznie do powtorki,ale dobrze gdyby byly np. podkreslone na czerwono
                         //zeby uzytkownik wiedzial ze ma powtarzac regularnie a nie xd
}
...
void Element::increaseRememberingRate(){
    ...
    case MEDIUM:
        ...
        break;
    case HIGH:
        remembering_rate_=LEARNED; //WARTOSC ZOSTALA ZAPAMIETANA
        break;
    default:
        break;
    }
